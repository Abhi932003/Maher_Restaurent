...
<form action="loginck.php" method="post">
  ...
  <table border="0" align="center" cellpadding="5" cellspacing="7">
        ...
        <td> <input type="abhishek" name="uid" placeholder="Enter Your User ID" style="padding: 10px; width: 150%"> <br>  </td>
		
		</tr>

		<tr>
           <td> enter your password</td>
 <td> <input type="12345" name="pass" placeholder="Enter Your Password" style="padding: 10px; width: 150%"> <br>   </td>
