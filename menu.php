...
<?php include  "header.php"; ?>
			...
			<div class="row inner-menu-box">
				<div class="col-3">
					<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						...
						<a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">Maharashtrian Thali</a>
						<a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">Puranpoli</</a>
						<a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">Bharli Wangi</a>
                        <a class="nav-link" id="v-pills-bhakar-tab" data-toggle="pill" href="#v-bhakar-settings" role="tab" aria-controls="v-bhakar-settings" aria-selected="false">Pithla Bhakri</a>
						<a class="nav-link" id="v-pills-tava-tab" data-toggle="pill" href="#v-pills-tava" role="tab" aria-controls="v-pills-tava" aria-selected="false">Misal Pav</a>
					</div>
				</div>
				...
				<div class="photo-container">
                 <div>
				 <img class="photo" src="images\Maharashtrian_thali.jpg" alt="Photo 1">
                  <img class="photo" src="images\puranpoli.jpg" alt="Photo 2">
				 </div>
                 <div>
				 <img class="photo" src="images\Tarri-Pohe.jpg" alt="Photo 3">
				  <img class="photo" src="images\aamras.jpg" alt="Photo 3">
				 </div>
                  </div>
				</div>
  ...
  .photo {
    width:500px; /* 25% width with 10px margin */
  ...
  @media (max-width: 600px) {
    .photo {
      width: calc(100% - 10px); /* Full width with 10px padding */
    }
  }
</style>
